...
public:
	 ...
	 * @param	DelayDestroy			专门为延迟播放动画准备
	...
	static FPopupHandle CreatePopup(UObject* WorldContextObject, 
		TSubclassOf<UUI_SimplePopup> PopupClass,
		const FText &Content,ESimplePopupType SimplePopupType,
		...
		float Life = 10.f,float DelayDestroy = 0.f, bool bLockView = true);
