...
TSharedPtr<FSlateStyleSet> FSimpleCombatEditorStyle::StyleInstance = nullptr;

void FSimpleCombatEditorStyle::Initialize()
{
...
void FSimpleCombatEditorStyle::Shutdown()
{
...
FName FSimpleCombatEditorStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("SimpleCombatEditorStyle"));
	return StyleSetName;
}
...
void FSimpleCombatEditorStyle::ReloadTextures()
{
...
const ISlateStyle& FSimpleCombatEditorStyle::Get()
{
